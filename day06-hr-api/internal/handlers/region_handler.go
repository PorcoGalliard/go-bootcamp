...
func (h *RegionHandler) GetAllRegionsWithCountry(c *gin.Context) {
	regionsWithCountry, err := h.regionService.GetAllRegionsWithCountry(c.Request.Context())
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"error":   true,
...
func (h *RegionHandler) GetRegionByIDWithCountry(c *gin.Context) {
	...
	regionWithCountry, err := h.regionService.GetRegionByIDWithCountry(c.Request.Context(), uint(id))
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{
			"error":   true,
			"message": "Cannot find region with country",
			"details": err.Error(),
		})
	}
